...
This is due to the fact that in the Java<sup><font="-2">TM</font></sup> Development Kit (JDK<sup><font="-2">TM</font></sup>),
version 1.4.x, the mechanism of event dispatching has changed; consequently, for Foxtrot to be compatible with JDK 1.4.x
and 1.3.x, the Foxtrot implementation is required to be in the boot classpath.</p>
